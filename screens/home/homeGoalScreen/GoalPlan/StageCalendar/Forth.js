...
const Forth = ({ navigation }) => {
  ...
  const forthStartDay = navigation.getParam("forthStartDay");
  const division = navigation.getParam("division");

  const originDDay = navigation.getParam("originDDay");
  const [selectedDay, setSelectedDay] = useState();

  const [forthSelectedLastDay, setForthSelectedLastDay] = useState();

  const selectedDayHandle = (day) => {
    setForthSelectedLastDay(day.dateString);
    ...
    let startDate = moment(forthStartDay).format("YYYY-MM-DD");
    ...
    <View>
      ...
      >
        ...
        <TouchableOpacity
          onPress={() =>
            division === "create"
              ? navigation.navigate("GoalStackFour", { forthSelectedLastDay })
              : division === "edit"
              ? navigation.navigate("GoalEdit", { forthSelectedLastDay })
              : editDivision === "edit"
      ...
      <CalendarList
        current={forthStartDay}
        minDate={forthStartDay}
