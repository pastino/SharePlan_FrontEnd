...
const Second = ({ navigation }) => {
  ...
  const secondStartDay = navigation.getParam("secondStartDay");
  const division = navigation.getParam("division");

  const originDDay = navigation.getParam("originDDay");
  const [selectedDay, setSelectedDay] = useState();

  const [secondSelectedLastDay, setSecondSelectedLastDay] = useState();

  const selectedDayHandle = (day) => {
    setSecondSelectedLastDay(day.dateString);
    ...
    let startDate = moment(secondStartDay).format("YYYY-MM-DD");
    ...
    <View>
      ...
      >
        ...
        <TouchableOpacity
          onPress={() =>
            division === "create"
              ? navigation.navigate("GoalStackFour", { secondSelectedLastDay })
              : division === "edit"
              ? navigation.navigate("GoalEdit", { secondSelectedLastDay })
              : editDivision === "edit"
      ...
      <CalendarList
        current={secondStartDay}
        minDate={secondStartDay}
