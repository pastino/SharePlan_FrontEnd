...
const GoalStageCalendal = ({ navigation }) => {
  ...
  const selectedDayHandle = (day) => {
    setSelectedLastDay(day.dateString);
    ...
    <View>
      ...
      >
        ...
        <TouchableOpacity
          onPress={() =>
            division === "create"
              ? navigation.navigate("GoalStackFour", { selectedLastDay })
              : division === "edit"
              ? navigation.navigate("GoalEdit", { selectedLastDay })
              : editDivision === "edit"
              ? navigation.navigate("EditGoalStagePlan", { selectedLastDay })
              : navigation.navigate(
                  NavigationActions.navigate({
                    routeName: "GoalDetailContainer",
                    params: { selectedLastDay },
...
export default GoalStageCalendal;
